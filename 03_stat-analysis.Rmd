...
Dans cette partie nous allons filtrer nos données de travail. Cependant, contrairement au filtrage fait sur la partie de DADA2 ici nous allons filtrer en fonction, d'une part de la taxonomie, et d'autre part en fonction de la prévalence des taxons dans les échantillons. 
